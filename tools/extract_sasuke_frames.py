...
DEFAULT_SOURCE = Path("assets/sasuke_new/DS _ DSi - Jump Ultimate Stars - Fighters - Sasuke Uchiha.png")
DEFAULT_OUTPUT_DIR = Path("assets/sasuke_new")
...
def parse_args():
    parser = argparse.ArgumentParser(description="Extract Sasuke spritesheet frames.")
...
def main():
    ...
    for old_file in args.output_dir.glob("sasuke_*.png"):
        old_file.unlink()
