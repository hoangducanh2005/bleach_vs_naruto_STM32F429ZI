...
SOURCE = Path(r"C:\Users\Admin\Downloads\DS _ DSi - Jump Ultimate Stars - Fighters - Naruto Uzumaki.png")
OUTPUT_DIR = Path("assets/naruto_frames")
...
def main():
    ...
    for old_file in OUTPUT_DIR.glob("naruto_*.png"):
        old_file.unlink()

    for index, item in enumerate(frames):
        frame = make_transparent_frame(image, item["bbox"])
        filename = f"naruto_{index:03d}.png"
