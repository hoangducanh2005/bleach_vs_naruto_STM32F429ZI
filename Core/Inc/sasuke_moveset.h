...
typedef enum
{
  SASUKE_MOVE_IDLE = 0U,
  SASUKE_MOVE_RUN = 1U,
  SASUKE_MOVE_ATTACK1 = 2U,
  SASUKE_MOVE_ATTACK2 = 3U,
  SASUKE_MOVE_ATTACK3 = 4U,
  SASUKE_MOVE_BLOCK = 5U,
  SASUKE_MOVE_SKILL = 6U,
  SASUKE_MOVE_JUMP_STARTUP = 7U,
  SASUKE_MOVE_JUMP_AIR = 8U,
  SASUKE_MOVE_FALL = 9U,
  SASUKE_MOVE_JUMP_LAND = 10U,
  SASUKE_MOVE_HIT = 11U,
  SASUKE_MOVE_DEAD = 12U,
  SASUKE_MOVE_STATE_COUNT = 13U
} SasukeMoveState;
