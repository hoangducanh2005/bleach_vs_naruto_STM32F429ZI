...
typedef enum
{
  ...
  NARUTO_FULL_NINE_TAILS_MOVE_ATTACK4 = 9U,
  NARUTO_FULL_NINE_TAILS_MOVE_SKILL1 = 10U,
  NARUTO_FULL_NINE_TAILS_MOVE_SKILL2 = 11U,
  NARUTO_FULL_NINE_TAILS_MOVE_SKILL3 = 12U,
  NARUTO_FULL_NINE_TAILS_MOVE_DEAD = 13U,
  NARUTO_FULL_NINE_TAILS_MOVE_STATE_COUNT = 14U
