...
typedef enum
{
  ...
  ICHIGO_MOVE_RUN = 1U,
  ICHIGO_MOVE_DASH = 2U,
  ICHIGO_MOVE_ATTACK_LIGHT = 3U,
  ICHIGO_MOVE_ATTACK2 = 4U,
  ICHIGO_MOVE_ATTACK3 = 5U,
  ICHIGO_MOVE_BLOCK = 6U,
  ICHIGO_MOVE_SKILL = 7U,
  ICHIGO_MOVE_JUMP = 8U,
  ICHIGO_MOVE_HIT = 9U,
  ICHIGO_MOVE_DEAD = 10U,
  ICHIGO_MOVE_STATE_COUNT = 11U
} IchigoMoveState;
